                                                ...
                                                <div className="doctor-information-card mb-4">
                                                    <div className="doctor-main-profile-card">
                                                        ...
                                                        <div className="doctor-content-details">
                                                            <div className="doctor-info-heading d-flex align-items-center justify-content-between">
                                                                <div>

                                                                    <h4>{data?.name}</h4>
                                                                    <p>{data?.nh12}</p>
                                                                </div>
                                                                <a target="_blank" href={`https://patient.neohealthcard.com/lab-detail/${data?.name}/${data?._id}`} className="nw-thm-btn">Book Appointment</a>
                                                            </div>
                                                            ...
                                                            <div className="lab-thumb-bx">
                                                                ...
                                                                <div className="lab-license-bx ">
                                                                    ...
                                                                    <div className="lab-certificate-dwn">
                                                                        <div>
                                                                            <h6 ><FontAwesomeIcon icon={faFilePdf} style={{ color: "#EF5350" }} /> Lab Lcense</h6>
                                                                        </div>
                                                                        <div className="">
